...
export default function BakeryPackaging() {
     const BakeryCategory = data.find(product => product.category === 'Bakery-packaging')
     const bakerypackaging = BakeryCategory ? BakeryCategory.products : [];
     return (

          <div class="row row-cols-2 row-cols-lg-4 g-2 g-lg-3 food-products  my-4 py-3">
               {bakerypackaging.map((product) => (
